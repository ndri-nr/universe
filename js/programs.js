...
import { FS_SCENE, FS_MW, FS_SS, FS_PULSAR, FS_NEBULA, FS_BRIGHT, FS_BLUR, FS_COMP } from './shaders.js';

export let P_SCENE, P_MW, P_SS, P_PULSAR, P_NEBULA, P_BRIGHT, P_BLUR, P_COMP;
try{
  if(gl){
